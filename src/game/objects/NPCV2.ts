...
/**
 * V2 版本的 NPC 類別
 * 與 V1 的主要差異：支援 3 則對話，由 DialogueManagerV2 管理點擊計數
 */
export class NPCV2 extends Phaser.GameObjects.Sprite {
    ...
    /**
     * V2 版本：觸發對話顯示（不傳遞具體對話內容，由 DialogueManagerV2 處理）
     */
    public showDialogue(): void {
        // 發送事件給 DialogueManagerV2，由它根據點擊次數決定顯示哪則對話
        this.scene.events.emit("show-dialogue-v2", {
